<?php $this->load->view('partial/header');?>
      <div class="android-content mdl-layout__content">
        ...
        <div class="mdl-typography content-list">
      		<form action="<?php echo base_url('manages/add_process');?>" method="post">
                    ...
                    <div class="mdl-dialog__actions">
                      <button type="submit" class="mdl-button">Add now</button>
                      <input type="reset" class="mdl-button close" value="Cancel"/>
                    </div>
                </form>
        </div>
        </div>
